...
import type { PlaygroundComponentName } from '../../data/playground-manifest'

import { computed, defineAsyncComponent, onMounted, ref } from 'vue'

import { findPlaygroundComponent } from '../../data/playground-manifest'
...
const componentLoaders: Record<PlaygroundComponentName, ComponentLoader> =
  Object.assign(
    {
...
const demoLoaders: Partial<Record<PlaygroundComponentName, DemoLoader>> =
  Object.assign(
    {
    ...
    },
    {
      ...
      'agent-console': () =>
        import('./playgrounds/demos/agent-console-demo.vue'),
      'revogrid-adapter': () =>
...
const definition = computed(() => {
  return findPlaygroundComponent(props.name)
})
