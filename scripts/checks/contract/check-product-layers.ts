...
const docs: RequiredDoc[] = [
  ...
  },
  {
    ...
    mustContain: [
      ...
      'Release readiness checks validate publishable package metadata, build outputs, tarball contents, published dist-tags, release-bound SLSA provenance and isolated consumer smoke paths.',
