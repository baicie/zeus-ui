...
const rawAiMetadata: ZeusWebAiMetadata = {
  ...
  advancedComponents: [
    ...
    },
    {
      ...
      slots: {
        'zw-virtual-list': ['default'],
      },
      events: {
        'zw-virtual-list': ['range-change', 'scroll-offset-change'],
      },
      methods: {
        'zw-virtual-list': [
          'getRange',
    ...
    },
    {
      ...
      components: ['zw-revogrid-adapter'],
      slots: {
        'zw-revogrid-adapter': [],
      },
      events: {
        'zw-revogrid-adapter': ['adapter-ready', 'adapter-change'],
      },
      methods: {
        'zw-revogrid-adapter': [
          'getRevoColumns',
